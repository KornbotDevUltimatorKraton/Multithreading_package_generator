...
components = ['drv8212','drv8428e','drv8320','drv8848']
Processing_component_packages(components[0]) 

if  __name__ =='__main__': 
          t1 = threading.Thread(target=Processing_component_packages(components[0]))
          t2 = threading.Thread(target=Processing_component_packages(components[1]))
          t1.start()
          t2.start() 
          t1.join()
          t2.join()
...
if __name__ =="__main__": 
       ...
       for i in components:
            p1 = multiprocessing.Process(target=Processing_component_packages(i))
            p1.start() 
            p1.join() 
'''       
